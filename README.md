...
**SlicePDF** is a lightweight, cross-platform desktop application designed to split and merge PDF files , compress , Merge with images, organize pages, Generate images with PDF etc. Built with Tauri and Rust for maximum performance and security.
